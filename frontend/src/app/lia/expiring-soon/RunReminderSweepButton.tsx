  ...
  return (
    <>
      <button
        ...
        className="min-h-[40px] inline-flex items-center gap-1.5 rounded-lg border border-[#c9a961]/40 bg-[#c9a961]/10 text-[#1E3A5F] text-xs font-semibold px-3 py-2 hover:border-[#c9a961] transition-colors"
      >
        <Zap size={12} />
        Run reminders now
      </button>
            ...
            {result === null && (
              <>
                ...
                <div className="flex items-center justify-end gap-2">
                  ...
                  <button type="button" onClick={handleSubmit} disabled={submitting} className="min-h-[44px] px-5 py-2 rounded-xl bg-[#1E3A5F] text-white text-sm font-bold hover:bg-[#c9a961] hover:text-[#1E3A5F] disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-not-allowed">
            ...
            {result !== null && (
              <>
                ...
                <div className="flex items-center justify-end">
                  <button type="button" onClick={close} className="min-h-[44px] px-4 py-2 rounded-xl bg-[#1E3A5F] text-white text-sm font-semibold hover:bg-[#c9a961] hover:text-[#1E3A5F]">
                    Close
                  </button>
                </div>
              </>
