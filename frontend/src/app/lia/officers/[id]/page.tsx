              ...
              {observations.map((o) => (
                <li key={o.id} className="rounded-xl border border-gray-100 bg-white p-4">
                  <div className="flex items-center gap-2 flex-wrap mb-2">
                    ...
                    {o.authorId === myId && (
                      <span className="text-[10px] font-bold uppercase tracking-wider text-[#b28f4e] ml-1">You</span>
                    )}
      ...
      <Card>
        <CardContent>
          <div className="flex items-center gap-2 mb-4">
            <Briefcase size={18} className="text-[#b28f4e]" />
                    ...
                    {linkages.map((l) => (
                      <tr key={l.id} className="hover:bg-[#FAF8F3]/50">
                        ...
                        <td className="px-3 py-2 text-right">
                          <Link href={`/lia/cases/${l.caseId}`} className="inline-flex items-center gap-1 text-sm font-medium text-[#1E3A5F] hover:text-[#b28f4e]">
