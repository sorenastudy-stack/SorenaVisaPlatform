  ...
  return (
    <>
      <button
        ...
        className="min-h-[44px] inline-flex items-center gap-2 rounded-xl bg-[#c9a961] text-[#1E3A5F] text-sm font-bold px-4 py-2 hover:bg-[#b28f4e] transition-colors shadow-sm"
      >
        <Plus size={16} />
        Add officer
      </button>
