  ...
  return (
    <>
      <button
        ...
        className="min-h-[48px] inline-flex items-center justify-center gap-2 rounded-xl bg-[#1E3A5F] text-white text-sm font-semibold px-4 py-2.5 hover:bg-[#c9a961] hover:text-[#1E3A5F] transition-colors"
      >
        <Send size={16} />
        Send message
      </button>
