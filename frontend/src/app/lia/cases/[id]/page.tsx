  ...
  if (errorMsg || !caseData) {
    return (
      <div className="max-w-3xl">
        <Link href="/lia/cases" className="inline-flex items-center gap-1 text-sm text-[#1E3A5F] hover:text-[#b28f4e] mb-4">
  ...
  return (
    <div className="max-w-7xl">
        ...
        <div className="flex items-start justify-between gap-3 flex-wrap">
          ...
          <div className="flex items-center gap-2 flex-wrap flex-shrink-0">
            ...
            <Link
              ...
              className="min-h-[44px] inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white border border-[#c9a961]/40 text-[#1E3A5F] text-sm font-semibold hover:border-[#c9a961] hover:text-[#b28f4e] transition-colors"
            >
            ...
            <Link
              ...
              className="min-h-[44px] inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#1E3A5F] text-white text-sm font-semibold hover:bg-[#c9a961] hover:text-[#1E3A5F] transition-colors"
            >
        ...
        <CardContent>
          <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
            <h2 className="text-lg font-bold text-[#1E3A5F] flex items-center gap-2">
              <Files size={18} className="text-[#b28f4e]" />
      ...
      <Card className="mb-6">
        <CardContent>
          <div className="flex items-center gap-2 mb-4">
            <MessageSquare size={18} className="text-[#b28f4e]" />
      ...
      <Card>
        <CardContent>
          <div className="flex items-center gap-2 mb-4">
            <Scale size={18} className="text-[#b28f4e]" />
...
function InzSubmissionPanel({ caseData }: { caseData: CaseDetail }) {
  ...
  if (caseData.stage === 'VISA' && !submitted) {
    return (
      <div className="mb-6 rounded-xl border-2 border-[#c9a961]/40 bg-[#c9a961]/5 p-5 flex items-center gap-4 flex-wrap">
        <div className="flex-1 min-w-0">
  ...
  if (caseData.stage === 'INZ_SUBMITTED' && submitted) {
    ...
    return (
      <section className="mb-6 rounded-xl border border-[#c9a961]/40 bg-white p-5">
        <div className="flex items-center gap-2 flex-wrap mb-4">
          <CheckCircle2 size={18} className="text-emerald-600" />
          <h2 className="text-base font-bold text-[#1E3A5F]">INZ Submission</h2>
          <span className="inline-flex items-center px-2 py-0.5 rounded-lg text-xs font-bold bg-[#c9a961]/20 text-[#1E3A5F] border border-[#c9a961]/40 ml-1">
            SUBMITTED
          </span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
        <div>
          ...
          <Link
            ...
            className="text-sm font-bold text-[#1E3A5F] hover:text-[#b28f4e] inline-flex items-center gap-1"
          >
