  ...
  return (
    <>
      <button
        ...
        className="min-h-[40px] inline-flex items-center gap-1.5 rounded-lg bg-[#1E3A5F] text-white text-xs font-bold px-3 py-2 hover:bg-[#c9a961] hover:text-[#1E3A5F] transition-colors"
      >
        <UserSquare2 size={12} />
              ...
              <>
                ...
                {search.trim().length > 0 && !loading && results.length === 0 && (
                  <div className="text-sm text-[#4A4A4A]/70 bg-[#FAF8F3] border border-gray-200 rounded-lg p-3 mb-2">
                    ...
                    <Link href="/lia/officers" className="underline font-semibold text-[#1E3A5F] hover:text-[#b28f4e]">
