  ...
  return (
    <>
      <button
        ...
        className="min-h-[48px] inline-flex items-center justify-center gap-2 rounded-xl border-2 border-[#c9a961]/40 bg-[#c9a961]/10 text-[#1E3A5F] text-sm font-semibold px-4 py-2.5 hover:border-[#c9a961] transition-colors"
      >
        <Gavel size={16} />
        Record decision
      </button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md rounded-2xl bg-white shadow-xl p-6">
            ...
            <div className="mt-5 flex items-center justify-end gap-2">
              ...
              <button type="button" onClick={handleSubmit} disabled={!canSubmit} className="min-h-[48px] px-5 py-2.5 rounded-xl bg-[#1E3A5F] text-white text-sm font-semibold hover:bg-[#c9a961] hover:text-[#1E3A5F] disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-not-allowed">
                {submitting ? '…' : 'Record'}
              </button>
            </div>
          </div>
