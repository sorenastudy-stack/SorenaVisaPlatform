...
export function ExportFileNoteButtons({
  ...
  return (
    <div className="rounded-xl border border-[#c9a961]/40 bg-[#c9a961]/10 p-4">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        <button
          ...
          className="min-h-[40px] inline-flex items-center gap-1.5 rounded-lg bg-[#1E3A5F] text-white text-xs font-bold px-3 py-2 hover:bg-[#c9a961] hover:text-[#1E3A5F] transition-colors disabled:opacity-50"
        >
          <FileDown size={12} />
        ...
        <button
          ...
          disabled={pending !== null}
          className="min-h-[40px] inline-flex items-center gap-1.5 rounded-lg bg-white border border-[#1E3A5F]/30 text-[#1E3A5F] text-xs font-bold px-3 py-2 hover:border-[#c9a961] hover:text-[#b28f4e] transition-colors disabled:opacity-50"
        >
          <FileText size={12} />
