    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
        <Link href="/sales/leads">
          <Card className="hover:border-[#c9a961] transition-colors cursor-pointer">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-[#1E3A5F]">
                <Users size={18} className="text-[#b28f4e]" />
                Total Leads
              </CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-[#1E3A5F]">
              <Calendar size={18} className="text-[#b28f4e]" />
              New Today
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-[#1E3A5F]">
              <Flame size={18} className="text-[#b28f4e]" />
              Hot Band
            </CardTitle>
          </CardHeader>
          <CardContent>
