  ...
  return (
    <div>
      ...
      <p className="text-sm text-[#4A4A4A]/70 mb-8">
        Booked consultations and your availability calendar.
      </p>
      <Card>
        <CardContent className="py-16 text-center">
          <Calendar size={32} className="mx-auto text-[#1E3A5F]/30 mb-3" />
          <p className="text-[#4A4A4A] font-medium">Coming soon</p>
          <p className="text-sm text-[#4A4A4A]/60 mt-1">
            Consultation scheduling is under construction.
          </p>
        </CardContent>
      </Card>
    </div>
