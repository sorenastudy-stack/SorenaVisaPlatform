...
export default async function ScorecardDetailPage({ params }: { params: { id: string } }) {
  ...
  if (errorMsg || !data) {
    return (
      <div className="max-w-4xl">
        <Link href="/staff/scorecards" className="text-sm text-[#1E3A5F] hover:text-[#b28f4e]">← Back to scorecards</Link>
  ...
  return (
    <div className="max-w-5xl">
      <Link href="/staff/scorecards" className="inline-flex items-center gap-1 text-sm text-[#1E3A5F] hover:text-[#b28f4e] mb-4">
        ← Back to scorecards
      </Link>
      ...
      <div className="flex items-start justify-between flex-wrap gap-3 mb-6">
        <div className="min-w-0">
          <h1 className="text-2xl font-bold text-[#1E3A5F] flex items-center gap-2">
            <ClipboardList size={22} className="text-[#b28f4e]" />
            {applicantName}
          </h1>
        ...
        <Card className="mb-6">
          <CardContent>
            ...
            <Link
              ...
              className="inline-flex items-center gap-1 text-sm font-medium text-[#1E3A5F] hover:text-[#b28f4e] mt-2"
            >
