    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md rounded-2xl bg-white shadow-xl p-6 max-h-[85vh] overflow-y-auto">
        ...
        <textarea
          ...
          className="w-full rounded-xl border border-gray-200 px-3 py-2 text-sm text-[#1e3a5f] focus:outline-none focus:ring-2 focus:ring-[#c9a961]/40 disabled:opacity-50"
        />
