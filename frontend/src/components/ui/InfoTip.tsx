  ...
  return (
    <span ref={ref} className="relative inline-flex items-center">
      <button
        ...
        className="inline-flex items-center justify-center text-[#1E3A5F]/40 hover:text-[#b28f4e] transition-colors focus:outline-none focus:text-[#b28f4e]"
      >
        <Info size={iconSize} />
      </button>
      ...
      {open && (
        ...
        >
          <span className="block font-semibold mb-1 text-[#b28f4e]">
            {entry.term}
          </span>
          {text}
        </span>
