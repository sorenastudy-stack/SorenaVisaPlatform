...
// engagement fee isn't PAID yet. Two tones:
//   • locked (default) — nothing uploaded yet: guide them to the pay screen.
//   • processing       — a receipt is uploaded, awaiting confirmation: a
//     reassuring "we're confirming it" state (from Piece #2), NOT a dead end.
// No dark patterns: plain language, one clear action.
