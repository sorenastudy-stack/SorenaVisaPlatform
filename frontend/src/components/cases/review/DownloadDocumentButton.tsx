  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-semibold text-[#1E3A5F] bg-white border border-gray-200 hover:border-[#c9a961] hover:text-[#b28f4e] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      >
