...
export function summarizeAuditEntry(entry: AuditEntryLike): string {
  ...
  switch (event) {
    ...
    case 'SCORECARD_CLIENT_PDF_GENERATED': {
      // PR-SCORECARD-3: newValue { submissionId, byStaff }.
      if (typeof newV === 'object' && newV !== null) {
        const byStaff = (newV as { byStaff?: unknown }).byStaff === true;
        return byStaff
          ? 'Client scorecard PDF generated by staff'
          : 'Client scorecard PDF downloaded';
      }
      return 'Client scorecard PDF generated';
    }
    case 'SCORECARD_INTERNAL_PDF_GENERATED':
      // PR-SCORECARD-3: newValue { submissionId, viewerUserId }.
      return 'Internal scorecard PDF generated by staff';
