...
function makeService(opts: {
  ...
  const service = new ContractsService(prisma, {} as any, {} as any, {} as any, {} as any, {} as any, {} as any, { getRateForInvoice: async () => ({ rate: 1.6423, source: 'exchangerate.host', timestamp: new Date()}) } as any);
