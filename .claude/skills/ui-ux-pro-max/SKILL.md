---
name: ui-ux-pro-max
description: "UI/UX design intelligence: style selection, layout systems, interaction patterns, accessibility, and visual quality review. 67 styles, 99 UX guidelines, 25 chart types, 21 stacks (React, Next.js, Vue, Svelte, Astro, SwiftUI, React Native, Flutter, WPF, WinUI 3, UWP, Avalonia, Uno Platform, Nuxt, Nuxt UI, Tailwind, shadcn/ui, Jetpack Compose, Three.js, Angular, Laravel). Actions: plan, design, recommend, review, critique, audit, improve, optimize UI/UX; choose a visual style, layout, or interaction pattern; check accessibility and usability. Projects: website, landing page, dashboard, admin panel, e-commerce, SaaS, portfolio, blog, mobile app, desktop app. Elements: button, modal, navbar, sidebar, card, table, form, chart. Styles: glassmorphism, claymorphism, minimalism, brutalism, neumorphism, bento grid, dark mode, responsive, skeuomorphism, flat design. Topics: accessibility, animation, layout, hierarchy, spacing, hover, shadow, gradient, visual polish. Suggests palettes and font pairings for greenfield projects only - where brand/design-system tokens already exist those tokens win, and this skill does not set final colour or typography values. For writing the actual React/Tailwind/shadcn code, use ui-styling."
---
...
> **Brand tokens win.** `--design-system` output — including MASTER.md — is a
> *recommendation*, and it is authoritative only when the project has no brand
> yet. If `assets/design-tokens.css` / `assets/design-tokens.json` exist (they do
> in this project, generated by `brand` → `design-system`), **read them and defer
> to them** for every colour and typography value. Use this skill's `colors.csv` /
> `typography.csv` to choose *style, layout, hierarchy, and UX patterns*, not to
> generate a rival palette. Where a recommendation conflicts with an existing
...
This creates:
- `ux-recommendations/MASTER.md` — Global reference for style/layout/UX rules
  (subordinate to brand tokens for colour and typography values)
- `ux-recommendations/pages/` — Folder for page-specific overrides

> Named `ux-recommendations/`, not `design-system/`, so it does not collide with
> the separate `design-system` skill that owns the actual token architecture.
...
This also creates:
- `ux-recommendations/pages/dashboard.md` — Page-specific deviations from Master

**How hierarchical retrieval works:**
1. When building a specific page (e.g., "Checkout"), first check `ux-recommendations/pages/checkout.md`
2. If the page file exists, its rules **override** the Master file
3. If not, use `ux-recommendations/MASTER.md` exclusively
4. For colour and typography *values*, `assets/design-tokens.css` overrides both

**Context-aware retrieval prompt:**
```
I am building the [Page Name] page. Please read ux-recommendations/MASTER.md.
Also check if ux-recommendations/pages/[page-name].md exists.
If the page file exists, prioritize its rules.
If not, use the Master rules exclusively.
For colors and fonts, defer to assets/design-tokens.css if it exists.
