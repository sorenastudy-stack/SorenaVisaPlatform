...
Persistence (Master + Overrides pattern):
  --persist    Save design system to ux-recommendations/MASTER.md
  --page       Also create a page-specific override file in ux-recommendations/pages/
"""
...
if __name__ == "__main__":
    ...
    # Persistence (Master + Overrides pattern)
    parser.add_argument("--persist", action="store_true", help="Save design system to ux-recommendations/MASTER.md (creates hierarchical structure)")
    parser.add_argument("--page", type=str, default=None, help="Create page-specific override file in ux-recommendations/pages/")
    ...
    if args.design_system:
        ...
        if args.persist:
            ...
            print("\n" + "=" * 60)
            print(f"✅ Design system persisted to ux-recommendations/{project_slug}/")
            print(f"   📄 ux-recommendations/{project_slug}/MASTER.md (style/layout/UX reference)")
            if args.page:
                page_filename = args.page.lower().replace(' ', '-')
                print(f"   📄 ux-recommendations/{project_slug}/pages/{page_filename}.md (Page Overrides)")
            print("")
            print(f"📖 Usage: When building a page, check ux-recommendations/{project_slug}/pages/[page].md first.")
            print(f"   If exists, its rules override MASTER.md. Otherwise, use MASTER.md.")
            print(f"   For colour/typography VALUES, assets/design-tokens.css overrides both.")
            print("=" * 60)
    # Stack search
    elif args.stack:
